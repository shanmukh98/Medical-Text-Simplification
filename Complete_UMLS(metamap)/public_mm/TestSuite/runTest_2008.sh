...
cat tmp | sed -e "s#$METAMAP#MetaMap#g" >> out
rm tmp
echo "========================================================================"
...
echo "MMI Fielded Output:" >> out
$METAMAP -N file5.txt tmp > /dev/null
cat tmp >> out
rm tmp
echo "========================================================================"

echo "Simple NegEx Machine Output"
echo "Simple NegEx Machine Output" >> out
$METAMAP -q file19.txt tmp > /dev/null
cat tmp >> out
rm tmp
echo "========================================================================"

echo "Simple NegEx XML Output"
echo "Simple NegEx XML Output" >> out
$METAMAP -% format -q file19.txt tmp > /dev/null
cat tmp >> out
rm tmp
echo "========================================================================"

echo "NegEx Machine Output"
echo "NegEx Machine Output" >> out
$METAMAP -q file20.txt tmp > /dev/null
cat tmp >> out
rm tmp
echo "========================================================================"
...
Gold_DIFF_CNT=`diff out gold.2008 | wc -l`
